  ...
  function changesCard(report) {
    ...
    return UI.card('כמה ירדת', 'כל תקופה מושווית לתקופה שלפניה',
      '<div class="table-scroll"><table class="data"><thead><tr>' +
        '<th>תקופה</th><th>משקל (ק״ג)</th><th>שומן (%)</th>' +
      '</tr></thead><tbody>' + rows + '</tbody></table></div>' +
      UI.basis('* טווח קצר מושפע מאוד ממלח, פחמימות ושעת השקילה. ' +
        'מספר של 3 ימים יכול להראות ירידה או עלייה של חצי קילו בלי ששום דבר אמיתי קרה. ' +
        'תסתכל על 7 ו-14 ימים כדי לדעת מה באמת קורה.'));
  }
